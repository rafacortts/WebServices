...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <div className="md:hidden flex items-center p-4 bg-neutral-900 text-white">
        <button onClick={handleOpenSidebar}>
          <HiOutlineMenu fontSize={28} />
        </button>
        {!isMobile && (
          <div className="flex items-center gap-2 ml-4">
            <MdDashboard fontSize={24} color={"#fff"}/>
      ...
      <div className={classNames(
        ...
        "bg-neutral-900 w-60 p-3 flex flex-col"
      )}>
        ...
        <div className="flex flex-col gap-0.5 pt-2 border-t border-neutral-700">
          ...
          <div className={classNames(linkClass, 'cursor-pointer text-red-500')} onClick={() => setSidebarOpen(false)}>
