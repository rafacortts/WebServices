...
function PopularProducts() {
  return (
    <div className="w-full sm:w-[20rem] bg-white p-4 rounded-sm border border-gray-200">
      <strong className="text-gray-700 font-medium">Em Alta</strong>
      <div className="mt-4 grid gap-4 sm:gap-3 grid-cols-1">
        {popularProducts.map((product) => (
          ...
          >
            <div className="w-10 h-10 min-w-[2.5rem] bg-gray-200 rounded-sm flex-shrink-0">
              <img
